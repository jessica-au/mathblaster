...
const handlePromptQuestion4 = (e) => {
    ...
    if (answer1 == "21") {
        document.querySelector('#p4').style.opacity = 1;
...
const handlePromptQuestion5 = (e) => {
    ...
    if (answer1 == "48") {
        document.querySelector('#p5').style.opacity = 1;
...
const handlePromptQuestion6 = (e) => {
    ...
    if (answer1 == "18") {
        document.querySelector('#p6').style.opacity = 1;
...
const handlePromptQuestion7 = (e) => {
    ...
    if (answer1 == "28") {
        document.querySelector('#p7').style.opacity = 1;
...
const handlePromptQuestion8 = (e) => {
    ...
    if (answer1 == "24") {
        document.querySelector('#p8').style.opacity = 1;
        document.querySelector('#p7').style.opacity = 0;
        document.querySelector('#position8').removeEventListener('click', handlePromptQuestion8);
        document.querySelector('#position9').addEventListener('click', handlePromptQuestion9);
        return
    } else if (lives <= 1) {
        lives--;
        document.querySelector('#livesLeft').innerHTML = `Lives: ${lives}`;
...
const handlePromptQuestion9 = (e) => {
    ...
    if (answer1 == "64") {
        document.querySelector('#p9').style.opacity = 1;
        document.querySelector('#p8').style.opacity = 0;
        document.querySelector('#position9').removeEventListener('click', handlePromptQuestion8);
        return
    } else if (lives <= 1) {
        lives--;
        document.querySelector('#livesLeft').innerHTML = `Lives: ${lives}`;
